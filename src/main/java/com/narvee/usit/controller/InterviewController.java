...
public class InterviewController {
	...
	public ResponseEntity<RestAPIResponse> getAllInterview(@PathVariable String flg, @PathVariable String access,
		...
		//System.out.println(flg+"  ==kiran  "+access+" ==kiran "+userid);
		...
		return new ResponseEntity<>(new RestAPIResponse("Success", "Interview fetched Successfully", alldata),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<RestAPIResponse> consultantdropdown(@PathVariable long id) {
		...
		return new ResponseEntity<>(new RestAPIResponse("Success", "Cons By id success", service.getSalesConsById(id)),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<RestAPIResponse> getsubmissiondropdown(@PathVariable String flg, @PathVariable long id,
			@PathVariable String role) {
		logger.info("!!! inside class : interviewController, !! method : submission details drop down ");
		return new ResponseEntity<>(new RestAPIResponse("Success", "submission details drop down By id success",
				service.submissiondetails(flg, id, role)), HttpStatus.OK);
	}
