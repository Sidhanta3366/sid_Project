...
public class ExcelUploads {
	...
	public static List<VendorDetails> convertExcelToVendor(InputStream is) throws IOException {
		...
		while (iterator.hasNext()) {
			...
			while (cellIterator.hasNext()) {
				...
				case 1:
					try {
						entity.setHeadquerter(cell.getStringCellValue());
					}
					...
					break;
				case 2:
					entity.setCompanytype(cell.getStringCellValue());
					break;
				case 3:
				...
				case 6:
					entity.setVms_stat(cell.getStringCellValue());
					break;

				case 7:
					entity.setStaff(cell.getStringCellValue());
					break;
